...
let enInput = document.getElementById('btn-encode');
let decoutput = document.getElementById('btn-decode');
...
enInput.addEventListener('click', encodeTex);
decoutput.addEventListener('click', decodeTxt);
